...
public class LoyaltyControl {
    ...
    public boolean redeemReward(String guestID, String rewardName) {
        ...
        RedemptionRecord redemption = new RedemptionRecord(record.getGuest(), rewardName, LocalDate.now());
    ...
    public int calculateTodayPointsUsedByReward(String rewardName) {
        ...
        int totalRedemptions
                = countTodayRedemptionsByReward(rewardName);

        int rewardPoints
                = getRewardPoints(rewardName);
    ...
    public DoublyLinkedList<LoyaltyRecord> getTopFiveMembersByPointsUsed(String selectedTier) {
        ...
        while (!filteredList.isEmpty() && topFiveList.getSize() < 5) {
            ...
            int highestPointsUsed
                    = highestRecord.getLifetimePoints()
                    - highestRecord.getAvailablePoints();
            ...
            for (int i = 2; i <= filteredList.getSize(); i++) {
                ...
                int currentPointsUsed
                        = currentRecord.getLifetimePoints()
                        - currentRecord.getAvailablePoints();
