...
public class HousekeepingControl {
    ...
    public static DoublyLinkedList<Room> rooms = new DoublyLinkedList<>();
    ...
    public static void loadRoomDatabase(){
        ...
        DoublyLinkedList<Room> loadedRooms = dao.retrieveFromFile();
        
        for(int i = 1 ; i <= loadedRooms.getSize() ; i++){
